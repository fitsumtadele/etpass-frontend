...
const PageRunOutForm = ({ formType, index, onPageUpdate, pagesAnswers, setViditure, prevButton, nextButton, setStep, handleStart, submitted }) => {
  ...
  const downloadPDF = () => {
    ...
    html2canvas(input).then((canvas) => {
     ...
     let pdf = new jsPDF('p', 'px', [1600, 1131]);
			...
			pdf.save('etpass-page-run-out-application.pdf');
  ...
  const renderForm = () => {
    return (
      <div>
        ...
        <>
          <h4>Renew Passport - For Passports That Ran Out Of Pages | Personal Details</h4>
          <div className="row">
            <div className="col-4">
            <FormItem
              item={{
        ...
        {index === 2 && (
          <>
            <h4>Renew Passport - For Passports That Got Damaged | Address</h4>
          <div className="row">
        ...
        {index === 3 && (
          <>
            <h4>Renew Passport - For Passports That Got Damaged | Passport Information</h4>
