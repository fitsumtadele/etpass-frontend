  ...
  const renderForm = () => {
    return (
      <div>
        ...
        <>
          <h4>Renew Passport - Passport Correction | Information</h4>
          <div className="row">
            <div className="col-4">
            <FormItem
              item={{
        ...
        {index === 2 && (
          <>
            <h4>Renew Passport - Passport Correction | Address</h4>
          <div className="row">
        ...
        {index === 3 && (
          <>
            <h4>Renew Passport - Passport Correction | Passport Information</h4>
