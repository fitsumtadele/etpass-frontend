...
const DamagedForm = ({ formType, index, onPageUpdate, pagesAnswers, prevButton, nextButton, setStep, handleStart, submitted }) => {
  ...
  const downloadPDF = () => {
    ...
    html2canvas(input).then((canvas) => {
     ...
     let pdf = new jsPDF('p', 'px', [1600, 1131]);
			...
			pdf.save('etpass-correction-application.pdf');
  ...
  const renderForm = () => {
    return (
      <div>
        ...
        <>
          <h4>Renew Passport - For Passports That Got Damaged | Personal Details</h4>
          <div className="row">
            <div className="col-4">
            <FormItem
              item={{
