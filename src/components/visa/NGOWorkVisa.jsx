...
const NGOWorkVisaForm = ({ formType, index, onPageUpdate, pagesAnswers, setViditure, prevButton, nextButton, setStep, handleStart, submitted,applicationNumber }) => {
  ...
  const downloadPDF = () => {
    ...
    html2canvas(input).then((canvas) => {
     ...
     let pdf = new jsPDF('p', 'px', [1600, 1131]);
			...
			pdf.save('etpass-ngo-visa-application.pdf');
  ...
  const renderForm = () => {
    ...
    return (
      ...
      {index === 1 && (
        ...
        <>
          <h4>NGO work Visa -| Arrival Information</h4>
          <div className="row">
            ...
            <div>
            <h4 className='my-4'>NGO Work Visa -| Address In Ethiopia</h4>
            </div>
            <Col xs={12} sm={6} md={6} lg={4}>
            <FormItem
              item={{
        ...
        {index === 2 && (
          <>
            <h4>For NGO Work Visa -| Personal Details</h4>
          <div className="row">
        ...
        {index === 3 && (
          <>
            <h4>For Tourist Visa | Address</h4>
...
export default NGOWorkVisaForm;