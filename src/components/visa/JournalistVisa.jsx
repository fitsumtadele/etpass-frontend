...
const JournalistVisaForm = ({ formType, index, onPageUpdate, pagesAnswers, setViditure, prevButton, nextButton, setStep, handleStart, submitted,applicationNumber }) => {
  ...
  const downloadPDF = () => {
    ...
    html2canvas(input).then((canvas) => {
     ...
     let pdf = new jsPDF('p', 'px', [1600, 1131]);
			...
			pdf.save('etpass-journalist-visa-application.pdf');
  ...
  const renderForm = () => {
    ...
    return (
      ...
      <>
        ...
        <>
          <h4>Journalist Visa -| Arrival Information</h4>
          <div className="row">
            ...
            <div>
            <h4 className='my-4'>Journalist Visa -| Address In Ethiopia</h4>
            </div>
            <Col xs={12} sm={6} md={6} lg={4}>
            <FormItem
              item={{
        ...
        {index === 2 && (
          <>
            <h4>For Journalist Visa -| Personal Details</h4>
          <div className="row">
        ...
        {index === 3 && (
          <>
            <h4>For Journalist Visa | Address</h4>
...
export default JournalistVisaForm;