...
const InvestmentVisaForm = ({ formType, index, onPageUpdate, pagesAnswers, setViditure, prevButton, nextButton, setStep, handleStart, submitted,applicationNumber }) => {
  ...
  const downloadPDF = () => {
    ...
    html2canvas(input).then((canvas) => {
     ...
     let pdf = new jsPDF('p', 'px', [1600, 1131]);
			...
			pdf.save('etpass-investment-visa-application.pdf');
  ...
  const renderForm = () => {
    ...
    return (
      ...
      <>
        ...
        <>
          <h4>Investment Visa -| Arrival Information</h4>
          <div className="row">
            ...
            <div>
            <h4 className='my-4'>Investment Visa -| Address In Ethiopia</h4>
            </div>
            <Col xs={12} sm={6} md={6} lg={4}>
            <FormItem
              item={{
        ...
        {index === 2 && (
          <>
            <h4>For Investment Visa -| Personal Details</h4>
            <div className="row">
        ...
        {index === 3 && (
          <>
            <h4>For Investment Visa | Address</h4>
...
export default InvestmentVisaForm;